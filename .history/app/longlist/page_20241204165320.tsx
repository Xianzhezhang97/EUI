...
const LongList: React.FC = () => {
  ...
  return (
    <m.div className='center relative flex flex-col justify-center items-center page-padding'>
      ...
      <div
        // ref={loaderRef}
        className='py-10 absolute bg-sky-100 p-4 bottom-3 h-48 flex justify-center items-center'
      >
        {isLoading ? (

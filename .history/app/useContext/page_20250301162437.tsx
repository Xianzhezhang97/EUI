      ...
      <div className='w-full flex flex-col text-gap'>
        ...
        <div>
          <div className='flex gap-x-4 mt-2 items-center'>
            <button className='one-btn' onClick={() => increment()}>
              +
            </button>
            <motion.h3
              layout
            ...
            <button className='one-btn' onClick={() => decrement()}>
              -
            </button>
        ...
        {Array.from({ length: 10 }, (_, i) => `item${i + 1}`).map((index) => (
          <div key={index}>
            ...
            <div className='flex gap-x-4 mt-2'>
              <button className='one-btn' onClick={() => increment(index)}>
                Increase
              </button>
              <button className='one-btn' onClick={() => decrement(index)}>
                Decrease
              </button>

      ...
      >
        ...
        <PP>
          {results.slice(0, 8).map((result, index) => (
            ...
            >
              <div className='relative inline-flex items-baseline justify-start gap-3'>
                <span
                  className={`text-2xl font-black group-hover:text-white
                    ${index < 3 ? 'text-sky-200  ' : 'text-gray-200  '}`}
                >
                  {index + 1}
                </span>
                <div>
